...
public class RPNCalculatorTest {
    ...
    @Test
    public void performAcceptsModulus() throws InvalidOperationTypeException, StackUnderflowException, StackOverflowException {
        calculator = new RPNCalculator(2);
        calculator.push(1);
        calculator.push(1);
        calculator.perform(new ModulusOperation());
        final int expected = 0;
        final int actual = calculator.getResult();
        assertEquals(expected, actual);
    }
    ...
    @Test
    public void performAcceptsModulusWithNoRemainder() throws InvalidOperationTypeException, StackUnderflowException, StackOverflowException {
        calculator = new RPNCalculator(2);
        calculator.push(9);
        calculator.push(3);
        calculator.perform(new ModulusOperation());
    ...
    @Test
    public void performAcceptsModulusWithRemainder() throws InvalidOperationTypeException, StackUnderflowException, StackOverflowException {
        calculator = new RPNCalculator(2);
        calculator.push(8);
        calculator.push(3);
        calculator.perform(new ModulusOperation());
    ...
    @Test
    public void processFormulaModuleZeros() throws InvalidOperationTypeException, StackUnderflowException, StackOverflowException {
        calculator = new RPNCalculator(2);
        final int expected = 0;
        String input = "16 4 %";
        final int actual = calculator.processFormula(input);
    ...
    @Test
    public void processFormulaWithMultipleModulus1() throws InvalidOperationTypeException, StackUnderflowException, StackOverflowException {
        calculator = new RPNCalculator(3);
        final int expected = 1;
        String input = "75 8 6 % %";
        final int actual = calculator.processFormula(input);
    ...
    @Test
    public void processFormulaWithMultipleModulus2() throws InvalidOperationTypeException, StackUnderflowException, StackOverflowException {
        calculator = new RPNCalculator(4);
        final int expected = 0;
        String input = "175 8 7 9 % % %";
        final int actual = calculator.processFormula(input);
        assertEquals(expected, actual);
    }

    @Test
    public void performAcceptsPrimeSumWithTwoInteger() throws InvalidOperationTypeException, StackUnderflowException, StackOverflowException {
        calculator = new RPNCalculator(2);
        calculator.push(5);
        calculator.push(7);
        calculator.perform(new PrimeSumOperator());
    ...
    @Test
    public void performAcceptsPrimeSumWithTwoIntegerSwapped() throws InvalidOperationTypeException, StackUnderflowException, StackOverflowException {
        calculator = new RPNCalculator(2);
        calculator.push(7);
        calculator.push(5);
        calculator.perform(new PrimeSumOperator());
    ...
    @Test
    public void performAcceptsPrimeSumOnlyPrimeInRange() throws InvalidOperationTypeException, StackUnderflowException, StackOverflowException {
        calculator = new RPNCalculator(2);
        calculator.push(5);
        calculator.push(5);
        calculator.perform(new PrimeSumOperator());
    ...
    @Test
    public void performAcceptsPrimeSumOnlyPrimeNumbersInRange2() throws InvalidOperationTypeException, StackUnderflowException, StackOverflowException {
        calculator = new RPNCalculator(2);
        calculator.push(7);
        calculator.push(7);
        calculator.perform(new PrimeSumOperator());
    ...
    @Test
    public void performAcceptsPrimeSumNoWithPrimeNumbersInRange() throws InvalidOperationTypeException, StackUnderflowException, StackOverflowException {
        calculator = new RPNCalculator(2);
        calculator.push(1);
        calculator.push(0);
        calculator.perform(new PrimeSumOperator());
    ...
    @Test
    public void performAcceptsPrimeSumNegativeWithPrimeNumbers() throws InvalidOperationTypeException, StackUnderflowException, StackOverflowException {
        calculator = new RPNCalculator(2);
        calculator.push(-25);
        calculator.push(-10);
        calculator.perform(new PrimeSumOperator());
    ...
    @Test
    public void performAcceptsPrimeSumWithNegativePrimeNumbersInRange() throws InvalidOperationTypeException, StackUnderflowException, StackOverflowException {
        calculator = new RPNCalculator(2);
        calculator.push(-25);
        calculator.push(25);
        calculator.perform(new PrimeSumOperator());
    ...
    @Test
    public void performAcceptsPrimeSumWithNegativePrimeNumbersInRange2() throws InvalidOperationTypeException, StackUnderflowException, StackOverflowException {
        calculator = new RPNCalculator(2);
        calculator.push(-1595);
        calculator.push(12);
        calculator.perform(new PrimeSumOperator());
    ...
    @Test
    public void processFormulaWithMultiplePrimeSums() throws InvalidOperationTypeException, StackUnderflowException, StackOverflowException {
        calculator = new RPNCalculator(10);
        final int expected = 124;
        String input = "5 8 @ 17 @ 5 @";
        final int actual = calculator.processFormula(input);
        assertEquals(expected, actual);
    }
