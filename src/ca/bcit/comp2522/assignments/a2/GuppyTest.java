...
public class GuppyTest {
    ...
    @Test
    public void NullIfGuppyTooYoung() {
        assertNull(testGuppy2.spawn());
    }

    @Test
    public void NullIfGuppyNotFemale() {
        assertNull(testGuppy2.spawn());
