...
public class PoolTest {
    ...
    @Test
    public void testZeroFryWhenMale() {
        int count = 5;
        for (int i = 0; i <= count; i++) {
            Guppy newGuppy = new Guppy("Poecilia",
                    "elegans",
        ...
        int numberOfNewFries = testPool.spawn();
        assertEquals(0, numberOfNewFries, 0);
    }

    @Test
    public void testZeroFryFemaleYoungerThanMinimumWeeks() {
        int count = 5;
        for (int i = 0; i <= count; i++) {
            Guppy newGuppy = new Guppy("Poecilia",
                    "elegans",
